...
__export(route_exports, {
  analysisProcessRoutes: () => analysisProcessRoutes
});
...
async function getAllAnalysisProcess(request, reply) {
  const querySchema = import_zod3.z.object({
    ...
    pageSize: import_zod3.z.string().optional()
  });
...
async function getAnalysisDetails(request, reply) {
  const querySchema = import_zod4.z.object({
    analysisId: import_zod4.z.string()
  });
...
// src/http/controllers/analysis-process/route.ts
async function analysisProcessRoutes(app) {
