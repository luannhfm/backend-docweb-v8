...
var make_get_reserv_by_prw_use_case_exports = {};
__export(make_get_reserv_by_prw_use_case_exports, {
  makeGetReservByPrwAndIdUseCase: () => makeGetReservByPrwAndIdUseCase
});
module.exports = __toCommonJS(make_get_reserv_by_prw_use_case_exports);
