...
var difference_repository_exports = {};
__export(difference_repository_exports, {
  DifferenceRepository: () => DifferenceRepository
});
module.exports = __toCommonJS(difference_repository_exports);
...
__decorateClass([
  (0, import_typeorm3.ManyToOne)(() => AttentionPoint, (attentionPoint) => attentionPoint.differences)
], Difference.prototype, "attentionPoint", 2);
Difference = __decorateClass([
  (0, import_typeorm3.Entity)("difference")
], Difference);
