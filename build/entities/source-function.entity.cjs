...
__decorateClass([
  (0, import_typeorm.ManyToOne)(() => SourceTable, (sourceTable) => sourceTable.sourceTableFields, { onDelete: "CASCADE" })
...
__decorateClass([
  (0, import_typeorm2.ManyToOne)(() => Source, (source) => source.sourceTables, { onDelete: "CASCADE" })
...
__decorateClass([
  (0, import_typeorm3.Column)("integer")
...
__decorateClass([
  (0, import_typeorm3.Column)("smallint")
...
__decorateClass([
  (0, import_typeorm4.ManyToOne)(() => Source, (source) => source.sourceFunctions, { onDelete: "CASCADE" })
