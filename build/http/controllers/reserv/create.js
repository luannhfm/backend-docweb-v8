...
__decorateClass([
  (0, import_typeorm6.ManyToOne)(() => Source, (source) => source.Functions, { onDelete: "CASCADE" })
], SourceFunction.prototype, "Source", 2);
SourceFunction = __decorateClass([
  (0, import_typeorm6.Entity)("source_function")
], SourceFunction);
...
__decorateClass([
  (0, import_typeorm7.ManyToOne)(() => SourceTable, (sourceTable) => sourceTable.fields, { onDelete: "CASCADE" })
], SourceTableField.prototype, "sourceTable", 2);
SourceTableField = __decorateClass([
  (0, import_typeorm7.Entity)("source_table_field")
], SourceTableField);
...
__decorateClass([
  (0, import_typeorm8.ManyToOne)(() => Source, (source) => source.Tables, { onDelete: "CASCADE" })
], SourceTable.prototype, "source", 2);
__decorateClass([
  (0, import_typeorm8.OneToMany)(() => SourceTableField, (sourceTableField) => sourceTableField.sourceTable)
], SourceTable.prototype, "fields", 2);
SourceTable = __decorateClass([
  (0, import_typeorm8.Entity)("source_table")
], SourceTable);
...
__decorateClass([
  (0, import_typeorm9.Column)("smallint", { default: 0 })
], Source.prototype, "status", 2);
__decorateClass([
  (0, import_typeorm9.Column)("boolean")
], Source.prototype, "reserv", 2);
__decorateClass([
  (0, import_typeorm9.OneToMany)(() => SourceFunction, (sourceFunction) => sourceFunction.Source)
], Source.prototype, "Functions", 2);
__decorateClass([
  (0, import_typeorm9.OneToMany)(() => SourceTable, (sourceTable) => sourceTable.source)
], Source.prototype, "Tables", 2);
Source = __decorateClass([
  (0, import_typeorm9.Entity)("source")
], Source);
...
var CreateReservUseCase = class {
  constructor(reservRepository) {
    this.reservRepository = reservRepository;
  }
  async handler(reserv) {
    await this.reservRepository.create(reserv);
  }
};

// src/use-cases/factory/reserv/make-create-reserv-use-case.ts
function makeCreateReservUseCase() {
  const reservRepository = new ReservRepository();
  return new CreateReservUseCase(reservRepository);
}

// src/http/controllers/reserv/create.ts
async function createReserv(request, reply) {
  const bodySchema = import_zod2.z.object({
    fonte: import_zod2.z.string(),
    dev: import_zod2.z.string(),
    data_ini: import_zod2.z.string(),
    hora: import_zod2.z.string(),
    data_fim: import_zod2.z.string().optional(),
    hora_fim: import_zod2.z.string().optional(),
    source_ori: import_zod2.z.string(),
    source_dev: import_zod2.z.string().optional()
  });
  const reservData = bodySchema.parse(request.body);
