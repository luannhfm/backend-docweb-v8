...
var get_by_uuid_exports = {};
__export(get_by_uuid_exports, {
  getSourceByUuid: () => getSourceByUuid
});
module.exports = __toCommonJS(get_by_uuid_exports);
...
async function getSourceByUuid(request, reply) {
  const paramsSchema = import_zod2.z.object({
    uuid: import_zod2.z.string()
  });
