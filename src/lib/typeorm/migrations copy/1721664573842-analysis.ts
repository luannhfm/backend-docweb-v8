...
export class Analysis1721666809328 implements MigrationInterface {
    name = 'Analysis1721666809328'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "hist_source" (
            ...
            "sourceOld" text, 
            CONSTRAINT "PK_8d77a0c28c829f414434bbdb240" PRIMARY KEY ("id")
        )`);
        ...
        await queryRunner.query(`CREATE TABLE "analysis" (
            "id_analysis" character varying NOT NULL, 
            "analysis" json NOT NULL, 
            "status" character varying NOT NULL, 
            CONSTRAINT "PK_b1f137b9b62b0fa509970379b19" PRIMARY KEY ("id_analysis")
        )`);
        ...
        await queryRunner.query(`CREATE TABLE "source_function" (
            ...
            "sourceId" integer, 
            CONSTRAINT "PK_dda489c69f4eed645a6fa0a9e12" PRIMARY KEY ("id")
        )`);
        ...
        await queryRunner.query(`CREATE TABLE "source_table_field" (
            ...
            CONSTRAINT "PK_c430380342d716ce744008a28d6" PRIMARY KEY ("id")
        )`);
        ...
        await queryRunner.query(`CREATE TABLE "source_table" (
            ...
            "name" character varying NOT NULL, 
            "sourceId" integer, 
            CONSTRAINT "PK_ab8e7571a21eb389978446e0a31" PRIMARY KEY ("id")
        )`);
        ...
        await queryRunner.query(`CREATE TABLE "difference" (
            ...
            CONSTRAINT "PK_1f0268f35add6e02298815c19f2" PRIMARY KEY ("id")
        )`);
        ...
        await queryRunner.query(`CREATE TABLE "attention_point" (
            ...
            "line_numbers" character varying NOT NULL, 
            "category" character varying NOT NULL, 
            "analysisResultIdAnalysis" character varying, 
            CONSTRAINT "PK_823e83621b2de4ccea92a0e1797" PRIMARY KEY ("id")
        )`);
        
        await queryRunner.query(`CREATE TABLE "analysis_result" (
            "id_analysis" character varying NOT NULL, 
            "status" character varying NOT NULL, 
            "dic" character varying NOT NULL, 
            "fontes" integer NOT NULL, 
            "fontes_points" integer NOT NULL, 
            "total_points" integer NOT NULL, 
            "created_at" TIMESTAMP NOT NULL DEFAULT now(), 
            CONSTRAINT "PK_7888e10e7871645fb54cf5dcfd8" PRIMARY KEY ("id_analysis")
        )`);
        ...
        await queryRunner.query(`
            ...
            VALUES 
            ('PONTO DE ENTRADA', 'Expressões presentes no arquivo values.txt'),
            ('CADASTROS', 'axcadastro;mbrowse;twbrowse'),
            ('RELATÓRIOS', 'axrelatorio; setprint; printer; treport'),
            ('CLASSES', 'class')
        `);
    }
